...
const listener = new THREE.AudioListener();
      ...
      audioLoader.load( 'assets/bensound-ukulele.mp3', function ( buffer ) {
      ...
      audioLoader.load( 'assets/bensound-hey.mp3', function ( buffer ) {
      ...
      audioLoader.load( 'assets/bensound-cute.mp3', function ( buffer ) {
